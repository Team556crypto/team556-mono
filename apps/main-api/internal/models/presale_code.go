...
type PresaleCode struct {
	...
	TokensClaimedP1P1 bool   `gorm:"default:false"`        // Whether the tokens have been claimed
	TokensClaimedP1P2 bool   `gorm:"default:false"`        // Whether the tokens have been claimed
	TokensClaimedP2   bool   `gorm:"default:false"`        // Whether the tokens have been claimed
	UserID            *uint  `gorm:"index"`                // Foreign key to the User who redeemed it (nullable)
