...
const HeroSection: React.FC<HeroSectionProps> = ({ onCreateWallet = () => {}, onLogin = () => {} }) => {
  const router = useRouter()
  const { isTabletOrLarger, width: screenWidth } = useBreakpoint() // Use the hook
        ...
        <View style={[styles.heroFlexContainer, isTabletOrLarger && styles.heroFlexContainerLarge]}>
          ...
          <View style={[styles.leftColumn, isTabletOrLarger && styles.leftColumnLarge]}>
            ...
            >
              ...
              <Text
                style={[
                  styles.heading,
                  isTabletOrLarger && styles.headingLarge,
                  { color: Colors.secondary, marginTop: 4, marginBottom: 24 }
                ]}
              >
                Digital Armory
              </Text>
              ...
              <Text style={[styles.subheading, isTabletOrLarger && styles.subheadingLarge]}>
                ...
                {'\n\n'}
                Manage your Team556 tokens, SOL, and firearm-related records in one streamlined wallet built for privacy
                and control. All data stays local to your device—never on-chain or in the cloud. With secure transaction
                handling on the Solana blockchain and offline storage for sensitive info, it's a purpose-built platform
                for those who value freedom, privacy, and preparedness.
              </Text>
            </Animated.View>
            ...
            >
              ...
              <Button title='Login' variant='outline' size='large' style={styles.loginButton} onPress={onLogin} />
            </Animated.View>
          ...
          {isTabletOrLarger && (
            <View style={styles.rightColumn}>
              <Animated.View style={[styles.mockupContainer, animatedStyle]}>
                <DashboardMockup />
              </Animated.View>
            </View>
          )}
...
const styles = StyleSheet.create({
  container: {
    ...
    overflow: 'hidden',
    zIndex: 1 // Ensure HeroSection is below the absolute positioned header (headerWrapper zIndex is 10)
  },
  contentContainer: {
    flex: 1,
