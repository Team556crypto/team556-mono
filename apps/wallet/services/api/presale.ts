...
import type { CheckPresaleCodeResponse, RedeemPresaleCodeRequest, RedeemPresaleCodeResponse } from './types'
...
export const redeemPresaleCode = async (
  ...
  return apiClient<RedeemPresaleCodeResponse>({
    method: 'POST',
    endpoint: '/wallet/presale/redeem',
    token,
    body: data
  })
}
