...
const styles = StyleSheet.create({
  ...
  drawerContainer: {
    ...
    boxShadow: Platform.OS === 'web' ? '0px -5px 10px rgba(0,0,0,0.15)' : undefined,
  ...
  dialogContainer: {
    ...
    boxShadow: Platform.OS === 'web' ? '0px 5px 15px rgba(0,0,0,0.3)' : undefined,
    shadowColor: Platform.OS === 'ios' ? 'rgba(0,0,0,0.3)' : undefined,
    shadowOffset: Platform.OS === 'ios' ? { width: 0, height: 5 } : undefined,
    shadowOpacity: Platform.OS === 'ios' ? 0.3 : undefined,
    shadowRadius: Platform.OS === 'ios' ? 15 : undefined,
    elevation: 24,
    zIndex: 2,
    overflow: 'hidden'
  },
